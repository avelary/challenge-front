...
export const ProductModal = ({ open, setOpen }: ProductModalProps) => {
  ...
  // States
  // --------------------------
  const [selectedCategory, setSelectedCategory] = useState<ProductCategoryValue | "">("");
  ...
  const classificationOptions = getClassificationOptionsByCategory(selectedCategory);
  ...
  <form className="fixed overflow-y-auto top-0 left-0 w-full h-[100vh] rounded-md bg-[#212121] pl-6 pr-6 pt-6">
    ...
    <div className="mt-[1rem] px-[1rem] py-[1rem] border border-[#878789] rounded-md">
      ...
      <div className="gap-[1rem] grid grid-cols-2 pb-[1rem]">
        ...
        <Select
          ...
          onChange={(value) =>
            setFormState({ ...formState, idPartner: value })
          }
        />
        ...
        <Select
          ...
          onChange={(value) =>
            setFormState({ ...formState, measure: value })
          }
        />
      ...
      <div>
        ...
        <Select
          ...
          onChange={(value) =>
            setFormState({ ...formState, idPrinter: value })
          }
        />
      </div>
    </div>
    ...
    {/* Upload da Imagem */}
     <UploadImage
        ...
        onUploadComplete={(url) => setFormState(prev => ({ ...prev, image: url }))}
      />
